...
export default class ProfileView extends React.Component {
  ...
  getUser = (token) => {
    const Username = localStorage.getItem("user");
    axios
      .get(`https://my-flix-app-2022.herokuapp.com/users/${Username}`, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((response) => {
        this.setState({
  ...
  editUser = (e) => {
    ...
    axios
      .put(
        `https://my-flix-app-2022.herokuapp.com/users/${Username}`,
        {
  ...
  onDeleteUser() {
    ...
    axios
      .delete(`https://my-flix-app-2022.herokuapp.com/users/${Username}`, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((response) => {
        console.log(response);
